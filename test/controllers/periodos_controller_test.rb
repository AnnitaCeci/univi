...
class PeriodosControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create periodo" do
    assert_difference('Periodo.count') do
      post periodos_url, params: { periodo: { current: @periodo.current, fin: @periodo.fin, inicio: @periodo.inicio, nombre: @periodo.nombre, tipo: @periodo.tipo } }
    end
  ...
  test "should update periodo" do
    patch periodo_url(@periodo), params: { periodo: { current: @periodo.current, fin: @periodo.fin, inicio: @periodo.inicio, nombre: @periodo.nombre, tipo: @periodo.tipo } }
