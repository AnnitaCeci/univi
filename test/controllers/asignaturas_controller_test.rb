...
class AsignaturasControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create asignatura" do
    assert_difference('Asignatura.count') do
      post asignaturas_url, params: { asignatura: { clave: @asignatura.clave, creditos: @asignatura.creditos, horas: @asignatura.horas, nombre: @asignatura.nombre } }
    end
  ...
  test "should update asignatura" do
    patch asignatura_url(@asignatura), params: { asignatura: { clave: @asignatura.clave, creditos: @asignatura.creditos, horas: @asignatura.horas, nombre: @asignatura.nombre } }
