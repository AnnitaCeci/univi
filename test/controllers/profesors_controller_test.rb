...
class ProfesorsControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create profesor" do
    assert_difference('Profesor.count') do
      post profesors_url, params: { profesor: { apellido_materno: @profesor.apellido_materno, apellido_paterno: @profesor.apellido_paterno, correo: @profesor.correo, domicilio: @profesor.domicilio, grado_academico: @profesor.grado_academico, grado_academico_abreviado: @profesor.grado_academico_abreviado, nombre: @profesor.nombre, rfc: @profesor.rfc, telefono: @profesor.telefono } }
    end
  ...
  test "should update profesor" do
    patch profesor_url(@profesor), params: { profesor: { apellido_materno: @profesor.apellido_materno, apellido_paterno: @profesor.apellido_paterno, correo: @profesor.correo, domicilio: @profesor.domicilio, grado_academico: @profesor.grado_academico, grado_academico_abreviado: @profesor.grado_academico_abreviado, nombre: @profesor.nombre, rfc: @profesor.rfc, telefono: @profesor.telefono } }
