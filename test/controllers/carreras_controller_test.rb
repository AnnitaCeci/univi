...
class CarrerasControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create carrera" do
    assert_difference('Carrera.count') do
      post carreras_url, params: { carrera: { clave: @carrera.clave, nombre: @carrera.nombre } }
    end
  ...
  test "should update carrera" do
    patch carrera_url(@carrera), params: { carrera: { clave: @carrera.clave, nombre: @carrera.nombre } }
