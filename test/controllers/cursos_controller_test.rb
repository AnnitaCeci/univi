...
class CursosControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create curso" do
    assert_difference('Curso.count') do
      post cursos_url, params: { curso: { asignatura_id: @curso.asignatura_id, periodo_id: @curso.periodo_id, profesor_id: @curso.profesor_id } }
    end
  ...
  test "should update curso" do
    patch curso_url(@curso), params: { curso: { asignatura_id: @curso.asignatura_id, periodo_id: @curso.periodo_id, profesor_id: @curso.profesor_id } }
