...
class AlumnosControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create alumno" do
    assert_difference('Alumno.count') do
      post alumnos_url, params: { alumno: { apellido_materno: @alumno.apellido_materno, apellido_paterno: @alumno.apellido_paterno, clave: @alumno.clave, correo: @alumno.correo, curp: @alumno.curp, nombre: @alumno.nombre } }
    end
  ...
  test "should update alumno" do
    patch alumno_url(@alumno), params: { alumno: { apellido_materno: @alumno.apellido_materno, apellido_paterno: @alumno.apellido_paterno, clave: @alumno.clave, correo: @alumno.correo, curp: @alumno.curp, nombre: @alumno.nombre } }
